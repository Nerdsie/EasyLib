...
public class IconClickEvent extends Event {
    ...
    private ChestIcon icon;
    private InventoryLocation location = null;
    private InventoryClickEvent event = null;

    public IconClickEvent(InventoryClickEvent e, Player p, ItemStack i, int slot, Inventory inv) {
        player = p;
        event = e;
        item = i;
        inventory = inv;
    ...
    public ChestIcon getIcon() {
        return icon;
    }

    public void setIcon(ChestIcon icon) {
        this.icon = icon;
    }
