package com.collinsrichard.myapi.objects.horse;
...
public class CustomHorse {
    ...
    /**
     * Creates a new instance of the CustomHorse, which allows you to change/get values of horses which aren't accessible with the bukkit api atm
     */
    public CustomHorse(LivingEntity horse) {
        if (!CustomHorse.isHorse(horse)) {
    ...
    /**
     * Creates a new instance of the CustomHorse; This constructor is only used for the static spawn method
     */
    private CustomHorse(Object entityHorse) {
     ...
     */
    public static CustomHorse spawn(Location loc) {
        ...
        try {
            ...
            return new CustomHorse(entityHorse);
        } catch (Exception e) {
            e.printStackTrace();
            return null;
        }
    ...
    public HorseType getType() {
        return HorseType.fromId(Integer.parseInt("" + NBTUtil.getValue(nbtTagCompound, Integer.class, "Type")));
    }
    ...
    public boolean isChested() {
        return Boolean.parseBoolean("" + NBTUtil.getValue(nbtTagCompound, Boolean.class, "ChestedHorse"));
    }
    ...
    public boolean isEating() {
        return Boolean.parseBoolean(NBTUtil.getValue(nbtTagCompound, Boolean.class, "EatingHaystack") + "");
    }
    ...
    public boolean isBred() {
        return Boolean.parseBoolean("" + NBTUtil.getValue(nbtTagCompound, Boolean.class, "Bred"));
    }
    ...
    public HorseVariant getVariant() {
        return HorseVariant.fromId(Integer.parseInt("" + NBTUtil.getValue(nbtTagCompound, Integer.class, "Variant")));
    }
    ...
    public int getTemper() {
        return Integer.parseInt("" + NBTUtil.getValue(nbtTagCompound, Integer.class, "Temper"));
    }
    ...
    public boolean isTamed() {
        return Boolean.parseBoolean("" + NBTUtil.getValue(nbtTagCompound, Boolean.class, "Tame"));
    }
    ...
    public boolean isSaddled() {
        return Boolean.parseBoolean("" + NBTUtil.getValue(nbtTagCompound, Boolean.class, "Saddle"));
    }
    ...
    private static class NBTUtil {
        ...
        public static boolean hasKey(Object nbtTagCompound, String key) {
            try {
                return Boolean.parseBoolean(ReflectionUtil.getMethod("hasKey", nbtTagCompound.getClass(), 1).invoke(nbtTagCompound, key) + "");
            } catch (Exception e) {
                e.printStackTrace();
                return false;
            }
